      ...
      <div className="text-center w-full max-w-2xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
          ...
          <button
            ...
            className="px-8 py-4 bg-stone-700 text-white font-bold rounded-md hover:bg-stone-600 transition-transform transform hover:scale-105 duration-300 focus:outline-none focus:ring-4 focus:ring-stone-500 focus:ring-opacity-75 text-xl shadow-lg shadow-stone-900/50"
          >
