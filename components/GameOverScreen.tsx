...
const GameOverScreen: React.FC<GameOverScreenProps> = ({ onRestart, onGoHome }) => {
  return (
    <div className="text-center p-8 mt-4 bg-black/20 border border-amber-800 rounded-lg flex flex-col items-center animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <button
          onClick={onGoHome}
          className="px-6 py-3 bg-white/5 text-white font-bold rounded-md hover:bg-white/10 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-stone-500 focus:ring-opacity-75 text-lg"
        >
          Main Menu
        </button>
      </div>
